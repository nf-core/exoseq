...
First, go to the [NGI-ExoSeq releases page](https://github.com/SciLifeLab/NGI-ExoSeq/releases) and find the latest version number - numeric only (eg. `0.8`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 0.8`.
